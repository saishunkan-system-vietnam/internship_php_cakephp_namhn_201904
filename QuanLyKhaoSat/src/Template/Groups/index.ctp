        ...
        <table class="table table-bordered table-striped">
            <tr  style="background-color: #333333;color: white">
                ...
                <th style="text-align: center">
                    <a href="<?= URL ?>groups/add" class="btn btn-success">
            ...
            <?php foreach ($data as $value) { ?>
                <tr>
                    ...
                    <th style="text-align: center">
                        <a href="<?= URL ?>groups/edit/<?php echo $value->id ?>" class="btn btn-primary">
                        ...
                        <a href="<?= URL ?>groups/lists/<?php echo $value->id ?>" class="btn btn-warning">
        ...
        $(".click").click(function () {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '<?= URL ?>groups/clickDelete?id=' + id,
                            type: 'GET',
