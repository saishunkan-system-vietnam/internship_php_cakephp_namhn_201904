<?php if (empty($groups)) { ?>
    <a href="<?= URL ?>groups"><h1><u style="color: red;font-weight: bold">Đường Link Này Không Tồn Tại</u></h1></a>
<?php } else { ?>
    ...
    <fieldset class="col-md-6 col-md-offset-3">
        ...
        <table class="table table-striped table-bordered">
            <tr style="background-color: #333333;color: white">
                ...
                <th>
                    ...
                    <button style="width: 110px;" onclick="listMember('<?= $groups->id ?>')" type="button"
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="modal-footer">
                                        <button style="width: 150px;height: 40px;" type="submit" class="btn"><i
                                                    class="fas fa-plus"></i> Add Member
                                        </button>
                                        </button>
                                        <button style="width: 100px;height: 40px;"
                                                type="button" class="btn" data-dismiss="modal"><i
                                                    class="fas fa-door-closed"></i> Close
                                        </button>
                                    </div>
                                </form>
                            </div>
                ...
                <?php foreach ($data as $key => $value) { ?>
                    <tr class="rows<?= $value['Details']['id'] ?>">
                        ...
                        <td class="col-md-4 rows<?= $value->id ?>">
                            <button style="width: 110px;" id="<?= $value['Details']['id'] ?>" type="button"
        ...
        <a href="<?= URL ?>groups">
            <button class="pull-right btn" style="width: 150px;height: 45px" type="button"><i
                        class="fas fa-undo-alt"></i> Page Groups
            </button>
        </a>
    </fieldset>
    <script>
