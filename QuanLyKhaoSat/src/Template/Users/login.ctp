...
<style>
    body {
        background: #222222 url(https://cssdeck.com/uploads/media/items/7/7AF2Qzt.png);
        color: #000;
        font: 14px Arial;
        margin: 0 auto;
        padding: 0;
    ...
    <section id="content">
        <form action="" id="formLogin" method="post">
            ...
            <div class="row form-group">
                <div class="col-md-1"><i class="fas fa-user-injured" style="font-size: 32px;margin-top: 10px;"></i></div>
