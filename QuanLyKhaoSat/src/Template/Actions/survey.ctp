            ...
            <?php if (isset($link) && $link == 'actions/survey/' . $dataSurvey->id) { ?>
                <fieldset class="col-lg-6 col-lg-offset-3" style="margin-top: 40px;">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th style="text-align: center;font-size: 25px;border-bottom: 1px solid #DDDDDD">Xin Trận
                                Thành
                                Cảm
                                Ơn ^^!
                            </th>
                    ...
                    <fieldset class="col-md-6 col-md-offset-3" style="font-size: 20px;">
                        <tr>
                            <td>
                                <blockquote>
                                    <i><u>Lưu Ý :</u></i>
                                    <footer style="font-size: 18px;">Câu Hỏi Chứa Dấu <span
                        ...
                        <?php if (isset($resultError)) { ?>
                            <h4 style="color: red;text-align: center"><u>Error ! Bạn đã sửa đáp án của chúng tôi</u>
                            </h4>
                        <?php } ?>
                        <?php if (isset($ErrorImg)) { ?>
                            <h4 style="color: red;text-align: center"><u>Error ! File bạn upload không phải là file
                                    Ảnh</u></h4>
                        <?php } ?>
                        ...
                        <table class="table table-hover">
                            <?php if (empty($dataQuestion)) { ?>
                                <tr>
                                    <th style="text-align: center;color: red;font-size: 25px;">Khảo Sát Đang Được Xây
                                        Dựng,
                                        Xin
                                        Vui Lòng
                                        Quay Lại Sau
                            ...
                            <?php if ($value->type_answer == "Images") { ?>
                                <tr>
                                    <th>
                                        <input type="file" accept="image/*" name="answers<?= $value->id ?>"
                                               id="i_file" data-error="#err<?= $value->id ?>">
                                    </th>
                                </tr>
                                <tr>
                                    <th><span id="err<?= $value->id ?>"></span></th>
                                    ...
                                    <th>
                                        <a href="<?= URL ?>actions">
                                            <button class="btn btn-danger pull-left" type="button"
                                                    style="width: 190px;height: 44px;line-height: 30px;font-size: 18px;">
                        ...
                        $("#KhaoSat").validate({
                            ...
                            messages: {
                                ...
                                answers<?= $value->id ?>: {
                                    ...
                                    minlength: "Câu Trả Lời Cần > <?= $value->min ?> Ký Tự",
                                    <?php if ($value->max != 0){?>
                                    maxlength: "Câu Trả Lời Cần < <?= $value->max ?> Ký Tự",
                                    <?php }?>
                                },
                                <?php }?>
                                <?php if ($value->type_answer == 'Radio' || $value->type_answer == 'Select') {?>
                                ...
                                answers<?= $value->id ?>: {
                                    ...
                                    minlength: "SỐ ĐIỆN THOẠI CÓ ÍT NHẤT <?= $value->min ?> SỐ",
                                    <?php if ($value->max != 0){?>
                                    maxlength: "SỐ ĐIỆN THOẠI CÓ NHIỀU NHẤT <?= $value->max ?> SỐ",
                                    <?php }?>
                                },
                                <?php }?>
                                //=========== End Tel ================
                                ...
                                answers<?= $value->id ?>: {
                                    ...
                                    minlength: "EMAIL CẦN CÓ ÍT NHẤT <?= $value->min ?> SỐ",
                                    <?php if ($value->max != 0){?>
                                    maxlength: "EMAIL CÓ NHIỀU NHẤT <?= $value->max ?> SỐ",
                                    <?php }?>
                                },
                                <?php }?>
                                //=========== End Email ================
